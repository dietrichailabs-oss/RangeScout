...
def build_release_set(
    *,
    ...
    if PRODUCT.version != "1.6.4" or not PRODUCT.build_identity.startswith("rs-v1.6.4-"):
        raise RuntimeError("RangeScout 1.6.4 release engineering requires an immutable 1.6.4 build identity")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build the RangeScout 1.6.4 internal QA artifact set.")
