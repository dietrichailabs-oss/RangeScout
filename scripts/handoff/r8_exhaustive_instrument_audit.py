"""Exhaustive R8 identity, provider-route, issuer, and Research semantic audit."""
...
def _database() -> Path:
    database = Path(tempfile.mkdtemp(prefix="rangescout-r8-exhaustive-")) / "history.sqlite"
...
def main() -> int:
    ...
    payload = {
        "schema": "rangescout.r8-exhaustive-semantic-instrument-audit.v1",
